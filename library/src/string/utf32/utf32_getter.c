...
fge_size_t fge_utf32_count(
    fge_utf32_cpt self
) {
    return self->count;
}

fge_size_t fge_utf32_capacity(
    fge_utf32_cpt self
) {
    return self->capacity;
}

fge_index_range_t fge_utf32_range(
    fge_utf32_cpt self
) {
    return (fge_index_range_t){ .lower = 0, .upper = self->count };
}

fge_index_t fge_utf32_start_index(
    fge_utf32_cpt self
) {
    return 0;
}

fge_index_t fge_utf32_end_index(
    fge_utf32_cpt self
) {
    return self->count;
}
