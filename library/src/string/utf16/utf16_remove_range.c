...
fge_bool_t fge_utf16_remove_range(
    fge_utf16_pt self,
    ...
    if (self->capacity > 0) {
        ...
        if (lower > 0) {
            fge_memory_copy((fge_memory_t){
                .ptr = new_ptr,
                .count = lower * sizeof(fge_utf16_unit_t)
            }, (fge_memory_t){
        ...
        if (upper < self->count) {
            fge_memory_copy((fge_memory_t){
                .ptr = &new_ptr[lower],
                .count = (self->count - upper) * sizeof(fge_utf16_unit_t)
            }, (fge_memory_t){
        ...
        fge_memory_move((fge_memory_t){
            ...
            .count = ((sizeof(fge_ptr_t) - upper) + 1) * sizeof(fge_utf16_unit_t)
        }, (fge_memory_t){
            .ptr = (fge_ptr_t)&old_ptr[upper],
            .count = ((sizeof(fge_ptr_t) - upper) + 1) * sizeof(fge_utf16_unit_t)
        });
