...
fge_bool_t fge_utf16_replace_last(
    fge_utf16_pt self,
    fge_rng_idx_t range,
    fge_utf16_buff_t find,
    fge_utf16_buff_t replace
) {
    fge_rng_idx_t find_range = fge_utf16_find_end(self, range, find);
...
fge_bool_t fge_utf16_replace_last_string(
    fge_utf16_pt self,
    fge_rng_idx_t range,
    fge_utf16_cpt find,
    fge_utf16_cpt replace
) {
    return fge_utf16_replace_last(self, range, (fge_utf16_buff_t){
